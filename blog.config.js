...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Naive', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Too young too simple👓', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lvrd.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'welcome, 博客', // 网站关键词 英文逗号隔开
